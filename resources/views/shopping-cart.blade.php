                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="p=price first-row">1tr$</td>
                                    ...
                                    <td class="total-price frist-row">1tr$</td>
                                    <td class="close-td first-row"><i class="ti-close"></i></td>
                                </tr>
                                <tr>
                                    <td class="cart-pic "><img src="front/img/cart-page/product-1.jpg" alt=""></td>
                                    <td class="cart-title "></td>
                                    <h5> Pure Pineapple</h5>
                                    <td class="p=price ">1tr$</td>
                                    <td class="p-price ">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                <input type="text" value="1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-4">
                            <div class="proceed-checkout">
                                <ul>
                                    <li class="subtotal">Subtotal <span>360tr$</span></li>
                                    <li class="cart-total">Total <span>240tr$</span></li>
                                </ul>
                                <a href="check-out.blade.php" class="proceed-btn">Proced to Check Out</a>
                            </div>
                        </div>
                    </div>
                </div>
